...
def create_div_mainctrl():
    ...
    return html.Div(
        children=[
            ...
            html.Div([html.Img(id="chem2D-image")], style={'height': 100} )
        ], 
...
def display_selected_data(
    ...
    if selected_points:
        ...
        src_str = b64string_image(smiles_list, molecule_name_list, num_molecules=num_molecules, return_encoding=False)
    else:
        return empty_plot
    return src_str
